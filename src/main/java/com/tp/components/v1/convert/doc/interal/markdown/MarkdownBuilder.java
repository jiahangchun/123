...
import com.tp.components.v1.convert.doc.interal.AbstractMarkupDocBuilder;
import com.tp.components.v1.convert.doc.interal.Markup;
...
public class MarkdownBuilder extends AbstractMarkupDocBuilder {
    ...
    public MarkupDocBuilder table(List<String> columns, List<List<String>> cells) {
        ...
        if (JMCommonUtil.isNotEmpty(columns)) {
