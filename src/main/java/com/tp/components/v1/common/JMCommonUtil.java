...
public class JMCommonUtil {
    ...
    public static ClassLoader getCurrentClassLoader() {
        ...
        if (cl == null) {
            cl = JMCommonUtil.class.getClassLoader();
        }
    ...
    public static void copyProperties(Object fromObj, Object toObj) throws Exception {
    ...
    public static String urlToString(String url) throws Exception {
        return JMCommonUtil.urlToString(url, HTTP_REQUEST_HEADERS, null);
    }
    ...
    public static String urlToString(String url, Map<String, String> headers, Map<String, Object> params) throws Exception {
        ...
        try {
            ...
            do {
                ...
                if (JMCommonUtil.isNotEmpty(headers)) {
                    for (Map.Entry<String, String> entry : headers.entrySet()) {
                        String key = entry.getKey();
                        String value = entry.getValue();
                        if (JMCommonUtil.isNotEmpty(key) && JMCommonUtil.isNotEmpty(value)) {
...
//            e.printStackTrace();
    ...
    public static String generateObjectByFieldToStr(Map<String, Object> propertyMap) {
        for (Map.Entry<String, Object> en : propertyMap.entrySet()) {
            ...
            if (JMCommonUtil.isEmpty(value)) {
                en.setValue("");
            }
        }

        try {
            Object object = JMCommonUtil.generateObjectByField(propertyMap);
